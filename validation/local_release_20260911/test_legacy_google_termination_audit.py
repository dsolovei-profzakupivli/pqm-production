...
class TerminationAuditTests(unittest.TestCase):
    ...
    def test_authoritative_google_categories_and_target_are_read_only(self):
        ...
        self.assertEqual(result["fields"]["m"]["google_present"], 3)
        self.assertEqual(result["fields"]["m"]["pqm_present"], 3)
        self.assertEqual(result["fields"]["m"]["google_present_pqm_missing"], 1)
        self.assertEqual(result["fields"]["m"]["different_nonblank"], 1)
        self.assertEqual(result["fields"]["m"]["google_blank_pqm_present"], 1)
