...
PERMISSIONS = [
 ...
 ('tasks.read','Операційні задачі','Перегляд операційних задач',True,False,r'/api/operational-tasks(?:/.*)?'),
 ('tasks.manage','Операційні задачі','Опрацювання операційних задач',True,True,r'/api/operational-tasks(?:/.*)?'),
